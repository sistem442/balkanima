...
<div class="container"> 
  ...
  <form action="studentApplicationResultSR.php" style="width:800px"  method="post" enctype="multipart/form-data" name="applicationForm">
...
<option>1</option>
    ...
    <div class="clearfloat"></div>
    <div class="left"> Datum produkcije</div>
    <div class="right">
    ...
    <div class="clearfloat"></div>
    <div class="spacer">&nbsp;</div>
    <div class="left">Format za prikazivanje</div>
    <div class="right">
      <select name="format" >
        <option>DVD</option>
    ...
    <div class="clearfloat"></div>
    <div id="prep" class="left">Kategorija filma</div>
    <div class="right">
    ...
    <div class="right" style="">Dozvoljavam da se 10 % trajanja filma mogu prikazati na televiziji radi informacije i promocije festivala. <div class="line"></div></div>
    <div class="clearfloat"></div>
    
    <div class="left">
      <input type="checkbox" id="dozvola2" name="dozvola2" />
    </div>
    <div class="right">Slažem se sa prikazivanjem mog filma na javnim nekomercijalnim projekcijama kojima se promoviše festival Balkanima kroz škole, kulturne institucije, festivale i filmska udruženja.          
    ...
    <div class="right">
		Slažem se da se fotografije i crteži iz filma mogu koristiti i na internetu za promociju festivala.    
		  <div class="line"> </div></div>
    <div class="clearfloat"></div>
    <div class="right"> * Popunjavanjem ove prijave smatra se da ste prihvatili<a href="http://localhost/joomlatest/index.php/en/rules">the proposition and the festival rules</a>. </div>
    <div class="clearfloat"></div>
    <div class="left"> Slika režisera<br />
      (max 1MB): </div>
    ...
    <div class="clearfloat"></div>
    <div class="left">Slika iz filma 22<br />
      (max 1MB):</div>
