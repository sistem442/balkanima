...
if ($_POST["vercode"] != $_SESSION["vercode"] OR $_SESSION["vercode"]=='')  { 
     die(  "<span ><strong>Niste dobro uneli brojeve sa slike</strong><br />
...
if(!$result2){
	die("
      ...
      <br />
     Greška br. 2. <br />
Kontaktirajte podršku  <a href='mailto:it@dksg.rs'>it@dksg.rs</a></span>");
}
...
//ako slike nisu selektovane ili su prevelike
	...
	die("<span>Niste odabrali slike ili su slike veće od 1MB. <br />
         <br />
...
<div class="container">
    <br />
<br />
Vaša prijava je uspešno primljena.<br />
<br />
Ako niste poslali link na video, pošalite DVD sa ID brojem: S<span style="font-size:14px; font-weight:bold"><?php echo $id?></span>. 
DVD pošaljite na sledeću adresu:<br />
<br />
<p><strong>Balkanima Festival<br />
  Dom kulture Studentski grad<br />
  Bulevar Zorana ĐninĐića 179<br />
  11070 Novi Beograd<br />
  Srbija</strong></p>
<p>Poslednji rok za slanje kopije filma je 30. jul 2014. (datum poštanskog pečata)<br /><br />
<br />
<br />
</p>
  <!-- end #container -->
