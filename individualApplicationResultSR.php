...
if ($_POST["vercode"] != $_SESSION["vercode"] OR $_SESSION["vercode"]=='')  { 
     die(  "<span ><strong>Uneli ste pogrešan kod sa slike molimo Vas da ponovo unesete kod.</strong><br />
<a href='javascript: history.go(-1)'>Nazad</a> </span>");
} 
...
$table_id = new id($mysqli,"prijaveindividual2013");
$id = $table_id->get_id();
...
$adresaProducenta = mysql_real_escape_string(trim($_POST["adresaProducenta"]));
$emailProducenta = mysql_real_escape_string(trim($_POST["emailProducenta"]));
$telefonProducenta = mysql_real_escape_string(trim($_POST["telefon"]));
...
$query2 = "
INSERT INTO prijaveindividual2013 (
`zemlja` ,
`originalniNaziv` ,
`engleskiNaziv` ,
`reziser` ,
...
`year`,
`preview_link`
) VALUES ('$zemlja','$originalniNaziv','$engleskiNaziv','$reziser',$id,'$adresaRezisera','$telefonRezisera','$emailRezisera','$biografija','$producent','$adresaProducenta','$emailProducenta','$telefonProducenta',$minuti,$sekunde,$mesecProizvodnje,$godinaProizvodnje,'$scenario','$animacija','$crtez','$scenografija','$trikKamera','$muzika','$zvucniEfekti','$montaza','$format','$sinopsis','$path1','$path2','$path','$dozvola1','$dozvola2','$dozvola3','$datum','$kategorija','$tehnikaRealizacije','$year','$preview_link')";
//echo $query2;
...
if(!$result2){
	die("
	  <span><br />
      <br />
     Do�lo je do greške br. 1. <br />
Molmo da grešku prijavite podršci: <a href='mailto:it@dksg.rs'>it@dksg.rs</a></span>");
}
...
//ako slike nisu selektovane ili su prevelike
	...
	die("<span>Niste izabrali sliku ili slika je ve�a od 1MB. <br />
         <br />
...
<div class="container">
    <br />
<br />
Film je uspešno prijavljen<br />
<br />
Ako niste poslali link na video, pošalite DVD sa ID brojem: A<span style="font-size:14px; font-weight:bold"><?php echo $id?></span>.
<br />
<br />
DVD pošaljite na sledeću adresu:
 <br />
<p><strong>Balkanima Festival<br />
  Dom kulture Studentski grad<br />
  Bulevar Zorana Đninđiđa 179<br />
  11070 Novi Beograd<br />
  Srbija</strong></p>
<p>Poslednji rok za slanje kopije filma je 30. jul 2014. (datum poštanskog pečata)<br />
<br />
<br />
<br />
</p>
