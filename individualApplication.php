...
<body>
<div class="container"> <img src="images/logoHorizontal.jpg" width="800" height="167"  />
  <div class="title">APPLICATION FORM</div>
  <form action="individualApplicationResult.php" style="width:800px"  method="post" enctype="multipart/form-data" name="applicationForm">
