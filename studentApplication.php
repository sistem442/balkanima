...
<body>
<div class="container"> 
	<img src="images/logoHorizontal.jpg" width="800" height="167"  />
  <div class="title">APPLICATION FORM</div>
  <form action="studentApplicationResult.php" style="width:800px"  method="post" enctype="multipart/form-data" name="applicationForm">
    <div class="left">Original title</div>
    <div class="right">
...
<option>1</option>
    ...
    <div class="clearfloat"></div>
    <div class="left"> Film Synopsis </div>
    <div class="right">
    ...
    <div class="right">
      <input type="text" style="width:500px;" id="school" name="school" onblur="ckeckIfEmty(this.value)"/>
    </div>
    <div class="clearfloat"></div>
    <div class="left"> School Address </div>
    <div class="right">
      <input type="text" style="width:500px;" id="schoolAddress" name="schoolAddress" onblur="ckeckIfEmty(this.value)"/>
    </div>
    <div class="clearfloat"></div>
    <div class="left"> School Telephone </div>
    <div class="right">
      <input type="text" style="width:500px;" id="schoolTelephone" name="schoolTelephone"/>
    </div>
    <div class="clearfloat"></div>
    <div class="left"> School E-mail </div>
    <div class="right">
      <input type="text" style="width:500px;" id="schoolEmail" name="schoolEmail" onblur="ckeckIfEmty(this.value), validateEmail(this.value)"/>
    </div>
    <div class="clearfloat"></div>
    <div class="spacer">&nbsp;</div>
    <div class="left">Format for screening</div>
    <div class="right">
      <select name="format" >
        <option>DVD</option>
        ...
        <option>35mm</option>
      </select> <span style="font-size:9px">*For selection screening send films in DVD format</span>
    </div>
    <div class="clearfloat"></div>
    <div class="left">Preview or download link</div>
    <div class="right">
      <input type="text" style="width:500px;" id="preview_link" name="preview_link" onblur="ckeckIfEmty(this.value)"/>
    </div>
    <div class="clearfloat"></div>
    <div class="left"> Script</div>
    <div class="right">
    ...
    <div class="clearfloat"></div>
    <div class="left"> Sound Desing</div>
    <div class="right">
      <input type="text" style="width:500px;" id="zvucniEfekti" name="zvucniEfekti"/>
    </div>
    <div class="clearfloat"></div>
    <div class="left"> Editing</div>
    <div class="right">
      <input type="text" style="width:500px;" id="montaza" name="montaza"/>
    </div>
    <div class="clearfloat"></div>
    <div class="left">Techniques of creation</div>
    <div class="right">
      <select name="tehnikeRealizacije" id="tehnikeRealizacije">
        <option value="Crtež na papiru / Drawing On Cell">Drawing On Cell</option>
        <option value="Lutka / Puppets">Puppets</option>
        <option value="Plastelin / Plasticine">Plasticine</option>
        <option value="Kolaž / Cut-Out">Cut-Out</option>
        <option value="Piksilacija / Pixilation">Pixilation</option>
        <option value="2D kompjuter / 2D Computer">2D Computer</option>
        <option value="3D kompjuter / 3D Computer">3D Computer</option>
        <option value="Druge tehnike / Other techniques">Other techniques</option>
      </select>
    </div>
    <div class="clearfloat"></div>
    <div id="otherTehniques" style="display:none">
      <div class="left"> Enter other techniques:</div>
      <div class="right">
    ...
    <div class="right" style="">I authorize the screening of my film till 10 % of its length on television for information purposes.<div class="line"></div></div>
    <div class="clearfloat"></div>
    
    <div class="left">
      <input type="checkbox" id="dozvola2" name="dozvola2" />
    </div>
    <div class="right">I agree with the public screening of my film in special programmes promoted by Balkanima with no commercial purposes, and that are included in cultural activites organized by Schools, Cultural Associations, Film Societies and Festivals.<div class="line"></div> </div>
    <div class="clearfloat"></div>
    ...
    <div class="clearfloat"></div>
    <div class="right"> * By completing this application you have accepted <a href="http://localhost/joomlatest/index.php/en/rules">the proposition and the festival rules</a>. </div>
    <div class="clearfloat"></div>
    <div class="left"> Photo of a director<br />
      (max size 1MB): </div>
    <div bgcolor="#999999" class="right">
      <input type="hidden" name="MAX_FILE_SIZE" value="1048576" />
      <input name="ufile[]" type="file" id="ufile[]" size="20" />
    </div>
    <div class="clearfloat"></div>
    <div class="left">Still from film 1<br />
      (max size 1MB):</div>
    <div bgcolor="#999999" class="right">
      <input type="hidden" name="MAX_FILE_SIZE" value="1048576" />
      <input name="ufile[]" type="file" id="ufile[]" size="20" />
    ...
    <div class="clearfloat"></div>
    <div class="left">Still from film 2<br />
      (max size 1MB):</div>
    <div class="right"  bgcolor="#999999">
      <input type="hidden" name="MAX_FILE_SIZE" value="1048576" />
      <input name="ufile[]" type="file" id="ufile[]" size="20" />
    </div>
    <div class="clearfloat"></div>
    <div class="right">
      <p>Send your films to the following address: <br />
        <br />
        ...
        Serbia</strong></p>
      <p>Application Deadline: July 30th, 2014 (date of postmark)</p>
...
<input type="submit" name="Submit" value="Submit" style="margin:5px; width:100px;" />
    <br/>
    <br/>
    <br/>
    <br/>
