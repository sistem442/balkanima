...
`year`,
`preview_link`
) VALUES ('$zemlja','$originalniNaziv','$engleskiNaziv','$reziser',$id,'$adresaRezisera','$telefonRezisera','$emailRezisera','$biografija','$producent','$adresaProducenta','$emailProducenta','$telefonProducenta',$minuti,$sekunde,$mesecProizvodnje,$godinaProizvodnje,'$scenario','$animacija','$crtez','$scenografija','$trikKamera','$muzika','$zvucniEfekti','$montaza','$format','$sinopsis','$path1','$path2','$path','$dozvola1','$dozvola2','$dozvola3','$datum','$tehnikaRealizacije','$year','$preview_link')";
//echo $query2;
...
<br />
If you didn't submited preview or download link send us DVD with this ID number: A<span style="font-size:14px; font-weight:bold"><?php echo $id?></span> to the following address:<br />
<br />
