...
function prikazi(id,year){
	window.location = "idResultStudent.php?id="+id+"&yearStudent="+year;
	}
</script>
<!-- InstanceEndEditable -->
</head>
...
$sql = mysql_query("SELECT * FROM prijavestudenti2013 WHERE year = $year ORDER BY id ASC");
...
<html>
<head>
<title>Studentska konkurencija</title>
<style type="text/css">
<!--
.pagNumActive {
    color: #000;
...
<body>
   <div style="margin-left:64px; margin-right:64px;">
     <h2>Ukupan broj prijava u pojedinačnoj konkurenciji: <?php echo $number_of_applications; ?></h2>
      ...
      <div style="margin-left:64px; margin-right:64px;">
	  <?php print "<table  border='2px' ><tr><td>Engleski naziv</td><td style='align:center'>ID broj</td></tr>
